<x-layout>
    ...
    <section class="mx-auto my-4 h-fit w-full px-6 sm:px-8 md:px-10 lg:px-16">
        ...
        <div class="rounded-xs mx-auto mb-6 flex w-full justify-between md:mb-8">
            <div class="grid h-fit grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
                <div
                    class="rounded-xs space-y-4 border border-gray-200 bg-white p-4 shadow md:p-6 lg:p-8 dark:border-gray-700 dark:bg-gray-900">
                ...
                <!-- Subscribe Form -->
                <div class="flex h-full flex-col justify-between lg:gap-4 xl:gap-6">
                    <div
                        class="rounded-xs space-y-2 border border-gray-200 bg-slate-900 p-4 shadow md:p-6 lg:p-8 dark:border-gray-700">
                        <div class="space-y-0.5">
                            ...
                            <p class="text-sm text-gray-400 dark:text-gray-400">
                                ...
                                <strong class="font-bebas-neue text-primary text-sm tracking-wider">Postly</strong>.
                                Subscribe now:
                            </p>
                        </div>
                        <form action="{{ route('newsletter.subscribe') }}" method="POST" class="w-full">
                            @csrf
                            <div class="inline-flex w-full items-center gap-1 rounded-sm bg-slate-800 p-1">
                                <x-input-label for="email" :value="__('Email')" class="sr-only" />
                                <div class="relative flex-1">
                                    <x-heroicon-o-envelope
                                        class="absolute left-2 top-1/2 z-10 mb-0.5 h-5 w-5 -translate-y-1/2 text-gray-500" />

                                    <x-text-input id="email"
                                        class="font-bebas-neue !dark:bg-gray-900 w-full flex-1 rounded-e-none !border-0 !border-none !bg-slate-800 pl-9 text-sm tracking-widest !text-gray-400 !outline-0"
                                ...
                                <button type="submit"
                                    class="font-bebas-neue rounded-xs bg-primary dark:bg-primary group inline-flex rounded-s-none px-4 py-1.5 tracking-wide transition-all duration-300">
                                    <span
                                        class="transition-all duration-300 group-hover:-translate-x-0.5">Subscribe</span>
                    ...
                    <div
                        class="rounded-xs space-y-2 border border-gray-200 p-4 shadow md:p-6 lg:p-8 dark:border-gray-700 dark:bg-gray-800">
                        <div class="space-y-0.5">
                        ...
                        <div class="inline-flex w-full flex-wrap gap-4">
                            {{-- Facebook --}}
                            <a href="#"
                                ...
                                <svg class="h-6 w-6 fill-current text-gray-100" viewBox="0 0 50 50">
                                    <path
                            ...
                            <a href="#"
                                ...
                                <svg class="h-6 w-6 fill-current text-gray-100" xmlns="http://www.w3.org/2000/svg"
