<x-layout>
    ...
    <section class="w-full h-fit my-4 mx-auto px-6 sm:px-8 md:px-10 lg:px-16">
        ...
        <div
            class="flex  flex-col rounded-xs p-4 md:p-6 lg:p-8  mx-auto w-full shadow-md border border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-700">
            <div class="inline-flex gap-4">
                <div class="max-w-md space-y-2">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">
                        <a href="/"
                            class="pr-0.5 font-bebas-neue tracking-wider hover:text-primary hover:underline">
                            Postly
