    ...
    <div class="w-full h-fit flex items-center justify-between py-4 px-6 sm:px-8 md:px-10 lg:px-16">
        ...
        <div class="inline-flex relative">
            <h1
                ...
                Postly
                <span class="h-3 w-[60%] bg-primary absolute bottom-4 left-[45%] -translate-x-1/2 -z-10"></span>
            </h1>
        </div>
        <div class="flex items-center gap-2 md:gap-2 font-bebas-neue tracking-wider text-base/4">
            @auth
                <span class="font-bebas-neue items-center dark:text-white text-sm/6 hidden sm:inline-flex gap-1">
                    <x-heroicon-o-user class="w-4 h-4 mb-0.5" />
                    {{ auth()->user()->username }}
                </span>
            @else
            ...
            <a href="#subscribe" id="subscribe"
                class="hidden sm:flex bg-primary hover:bg-primary/80 px-2.5 py-2 border dark:border-gray-900 shadow-[2px_2px_0px_#000] dark:shadow-[2px_2px_0px_#111827] active:translate-0.5 active:shadow-none">
                Subscribe
            </a>
