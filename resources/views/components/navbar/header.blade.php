<header class="grid place-self-center w-full sticky top-0 bg-background/50 dark:bg-background-foreground/50 backdrop-blur-xl z-50">
    <div class="w-full h-fit flex items-center justify-between py-4 px-6 sm:px-8 md:px-10 lg:px-16">
        ...
        <div x-data="{ isOpen: false }" class="relative">
            <!-- Hamburger Button -->
            <button @click="isOpen = !isOpen" type="button" class="-m-2.5 flex items-center justify-center gap-3 rounded-md p-2.5 text-gray-700 dark:text-white group hover:cursor-pointer z-50">
                ...
                <span class="uppercase font-bebas-neue sm:text-sm font-semibold tracking-[0.2em] group-hover:tracking-[0.26em] transition-all duration-200 mr-1 group-hover:mr-0">
                    menu
                </span>
            </button>
        ...
        <div class="inline-flex relative">
            <a href="/" class="ml-2 xs:ml-4 lg:ml-10 text-4xl md:text-5xl lg:text-[64px] tracking-wider font-bebas-neue dark:text-white">
                Postly
                <span class="h-1.5 sm:h-2 md:h-3 w-[60%] bg-primary absolute bottom-3 lg:bottom-4 left-1/3 md:left-[45%] -translate-x-1/2 -z-10"></span>
            </a>
        </div>
