@if ($paginator->hasPages())
    <div
        class="mt-4 p-4 bg-white border border-gray-200 shadow-md dark:bg-gray-900 dark:border-gray-700 transition-all duration-300">
        <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
            <div class="flex justify-between flex-1 font-bebas-neue sm:hidden">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                ...
                <div>
                    <span class="font-bebas-neue relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                        {{-- Previous Page Link --}}
                        @if ($paginator->onFirstPage())
                                ...
                                @foreach ($element as $page => $url)
                                    @if ($page == $paginator->currentPage())
                                        <span aria-current="page">
                                            <span
                                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-primary border border-gray-300 cursor-default leading-5 dark:bg-primary dark:border-gray-600">{{ $page }}</span>
                                        </span>
                                    @else
                                        <a href="{{ $url }}"
