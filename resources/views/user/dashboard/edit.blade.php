                ...
                <div class="flex flex-col gap-y-4 w-full dark:border-gray-700">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <a href="{{ route('posts.index') }}"
                            class="rounded-sm bg-transparent px-3 py-2 text-sm font-semibold text-gray-900 dark:text-gray-100 shadow-xs dark:hover:bg-gray-700 hover:bg-gray-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 border border-gray-300">
                            Cancel
                        </a>
                        <button type="submit"
