            ...
            <div class="flex flex-col gap-y-4 w-full dark:border-gray-700">
                ...
                <div class="flex w-full gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="flex flex-col w-full max-w-md">
                        ...
                        <x-text-input id="title" type="text" name="title" class="block mt-1 w-full" :has-error="$errors->has('title')" :value="old('title', $post->title)" autocomplete="title" />
                ...
                <div class="flex flex-col max-w-md">
                    ...
                    <div class="mt-2">
                        <div class="flex items-center justify-start rounded-sm bg-gray-50 dark:bg-gray-800 pl-3 outline-1 -outline-offset-1 outline-gray-300 dark:outline-gray-600 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-primary">
                            ...
                            <div class="w-full">
                                <x-text-input id="slug" type="text" name="slug" class="ml-1 pl-1 rounded-s-none" :has-error="$errors->has('slug')" :value="old('slug', $post->slug)" autocomplete="slug" />
                            </div>
                        </div>
                ...
                <div class="col-span-full max-w-sm">
                    ...
                    <div class="mt-2 flex flex-col items-start">
                        ...
                        {{-- Old Image --}}
                        <input type="hidden" name="oldCover_Image" value="{{ $post->cover_image ?? ($post->unsplash_image_url ?? '') }}">
                        ...
                        <div class="inline-flex items-center gap-2">
                            ...
                            <button id="btn-upload" type="button" onclick="document.getElementById('cover_image').click()" class="inline-flex justify-center items-center gap-0.5 rounded-sm bg-white dark:bg-gray-800 px-4 py-2 text-sm font-semibold text-gray-700 dark:text-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="#2F3A4A" class="w-5 h-5 pb-0.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 16V4m0 0l-5 5m5-5l5 5M4 16v4a1 1 0 001 1h14a1 1 0 001-1v-4" />
                                </svg>
                        ...
                        <div id="preview-container" class="mt-2 w-full hidden">
                            <div class="relative group overflow-hidden">
                                ...
                                {{-- Preview image - --}}
                                @if ($post->cover_image)
                                <img id="preview-image" src="{{ asset('storage/' . $post->cover_image) }}" alt="Image preview" class="max-h-72 h-auto w-full scale-100 group-hover:scale-110 transition-all ease-in-out duration-300 rounded-sm border border-gray-200 dark:border-gray-700 object-cover shadow-sm" />
                                @elseif ($post->unsplash_image_url)
                                <img id="preview-image" src="{{ $post->unsplash_image_url }}" alt="Image preview" class="max-h-72 h-auto w-full scale-100 group-hover:scale-110 transition-all ease-in-out duration-300 rounded-sm border border-gray-200 dark:border-gray-700 object-cover shadow-sm" />
                                @else
                                <img id="preview-image" alt="Image preview" class="max-h-72 h-auto w-full scale-100 group-hover:scale-110 transition-all ease-in-out duration-300 rounded-sm border border-gray-200 dark:border-gray-700 object-cover shadow-sm" />
                                @endif
                            </div>
                        </div>

                        <img id="preview-image" src="{{ old('cover_image') }}" class="w-64 mt-2" style="display: {{ old('cover_image') ? 'block' : 'none' }};">
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        ...
                        <trix-editor input="body" class="trix-content dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600"></trix-editor>
                    </div>
                    @error('body')
                ...
                <div class="col-span-full flex flex-col w-fit">
                    ...
                    <div class="mt-2 grid grid-cols-1 relative">
                        <select id="category_id" name="category_id" class="w-full appearance-none rounded-sm bg-white dark:bg-gray-800 py-1.5 pr-8 pl-3 text-base text-gray-900 dark:text-gray-100 outline-1 -outline-offset-1 outline-gray-300 dark:outline-gray-600 focus:outline-2 focus:-outline-offset-2 focus:outline-primary sm:text-sm/6">
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-6 space-y-6">
                        ...
                        <div class="flex items-center gap-x-3">
                            <input id="{{ $value }}" name="visibility" type="radio" value="{{ $value }}" {{ old('visibility', $post->visibility) === $value ? 'checked' : '' }} class="appearance-none h-4 w-4 checked:ring-primary checked:bg-primary checked:text-primary focus:ring-primary">
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    <a href="{{ route('posts.index') }}" class="rounded-sm bg-transparent px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs hover:bg-gray-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 border border-gray-300">
                        Cancel
                    </a>
