    ...
    @auth
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-14">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        @if (Auth::user()->role == 'admin')
                            ...
                            <x-nav-link href="{{ url('admin/categories') }}" :active="request()->routeIs('admin.categories')">
                                {{ __('Categories') }}
                            </x-nav-link>
                        @endif
                        ...
                        @if (Auth::user()->role == 'user')
                            <x-nav-link href="{{ url('users/posts/create') }}" :active="request()->routeIs('users.create-post')">
                                {{ __('Create New Posts') }}
                            </x-nav-link>
                            <x-nav-link href="{{ url('users/myposts') }}" :active="request()->routeIs('users.mypost')">
                                {{ __('My Posts') }}
                            </x-nav-link>
                            <x-nav-link href="{{ url('users/draft') }}" :active="request()->routeIs('users.draft')">
                                {{ __('Draft') }}
                            </x-nav-link>
                            <x-nav-link href="{{ url('users/trash') }}" :active="request()->routeIs('users.trash')">
                                {{ __('Trash') }}
                            </x-nav-link>
                        @endif
                ...
                <!-- Settings Dropdown -->
                <div class="hidden sm:flex sm:items-center sm:ms-6 border-primary">
